...
Each of the choices have a probability associated with them -- or thinking of it like there are small creeks branching off, or large rivers. Tiny doors, or large doors. I had a dream when I was very young, like five years old, that stuck with me. I was in a white room with a lot of doors, a lot like the one in Alice in Wonderland. And each of the doors was a different shape & size & colour. The room I was in was the "in-between", and I was getting to decide what I was going to experience next. Every night, when I went to dream, I got to choose a door. Some nights, I chose the big, obvious doors. Sometimes, the tiny, hidden ones. There's no point lingering in the "in-between", becaues each choice is as valid as the next. They are all experiences, and we are going to experience them all. Make a choice, and move on.
...
So this idea of the sixth-dimensional self gets even weirder. There's a though-experiment called [Quantum Suicide](https://en.wikipedia.org/wiki/Quantum_suicide_and_immortality) where you have a gun with a "quantum trigger" (just like [Schrödinger's cat](https://simple.wikipedia.org/wiki/Schr%C3%B6dinger%27s_cat)) where each time you pull the trigger, it both fires and doesn't fire. If you were to hold that gun up to your head, each time you pull the trigger, you would hear a click, but would still be alive. However, on a different branch in the fifth dimension, the gun went off, and that version of you is dead. You could theoretically pull that trigger infinite many times and it would never fire (though you would have infinite many dead selves in the other timelines).

But nevermind the theoretical gun. I feel like this applies in real life, with real decisions. There were times when I definitely should have died -- whether driving recklessly as a teenager, or health issues, or other accidents outside of my control. I'm not sure if you've ever had that "wow, I should be dead -- how am I not dead?" feeling, but I believe that's a time where we are aware of the possibility of that other timeline.

So I may be alive in this timeline, but there are many others in which I'm not. My family & friends would still be alive, and would have gone to my funeral. But this subjective version of myself never had to experience that. Knowing that my choices have ripples across timelines, I try to be more congnizent when I get myself into stupid situations. Even if I'm not causing loved ones pain in this timeline, I also don't want to cause them pain in alternate timelines.

I think one especially interesting application is, say, a terminal illness. For my friends and family, maybe I succombe to the virus, or to the cancer, or the heart attack, or whatever it might be. But for me, subjectively, I survive. It may suck to experience, and I may have life-long consequences to deal with as a result, but I am still alive.

I think this is an especially useful coping mechanism when applied to other people in our lives. For example, I put my dog down this summer after he was in the hospital for days having siezures. I cried like I've never cried before. But at the same time, I felt a sense of peace, like I was doing the right thing. I'd had a premonition a few months earlier that he didn't have long left -- that he had a brain tumour. And indeed, after doing a bunch of tests and ruling everything else out, three different vets at two different animal hospitals agreed that it was a brain tumour and that I should put him down. I still question myself, of course -- I'm human, and I still wonder if there was anything I could have done differently (or not done) which would have changed the outcome. And yet -- it's nice for me to think that there may be versions of myself and my dog that are still together, still going on adventures, still best friends.

As we go through life, the choices we make take us down different paths, but eventually, they lead to a place where there just aren't any more options -- the end of the line. It's like reading a "choose your own adventure" book, you get to a page that says "the end" -- you can backtrack to your previous choice, and read that till it says "the end", and backtrack to two choices ago, etc. But eventually, you've read the whole book. There are no more choices you can make, there is no more story, it truly is The End.
